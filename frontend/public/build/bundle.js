    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(button, "class", "chat-response svelte-12yv98n");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-12yv98n");
    			add_location(span, file$1, 112, 24, 3518);
    			attr_dev(p, "class", "svelte-12yv98n");
    			...
    			attr_dev(div1, "class", "chat-message-wrapper svelte-12yv98n");
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "chat-message bot svelte-12yv98n");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-12yv98n");
    			add_location(img0, file$1, 100, 12, 2995);
    			attr_dev(div0, "class", "chat-header-image svelte-12yv98n");
    			add_location(div0, file$1, 99, 8, 2951);
    			attr_dev(div1, "class", "chat-header-name svelte-12yv98n");
    			add_location(div1, file$1, 103, 12, 3101);
    			attr_dev(div2, "class", "chat-header-info svelte-12yv98n");
    			add_location(div2, file$1, 104, 12, 3159);
    			attr_dev(div3, "class", "chat-header-content svelte-12yv98n");
    			add_location(div3, file$1, 102, 8, 3055);
    			attr_dev(div4, "class", "chat-header svelte-12yv98n");
    			add_location(div4, file$1, 98, 4, 2917);
    			attr_dev(div5, "class", "chat-content svelte-12yv98n");
    			add_location(div5, file$1, 108, 8, 3280);
    			attr_dev(div6, "class", "chat-content-wrapper svelte-12yv98n");
    			add_location(div6, file$1, 107, 4, 3237);
    			attr_dev(textarea, "class", "chat-input svelte-12yv98n");
    			add_location(textarea, file$1, 142, 8, 4768);
    			if (!src_url_equal(img1.src, img1_src_value = "images/send.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Send");
    			attr_dev(img1, "class", "svelte-12yv98n");
    			add_location(img1, file$1, 151, 12, 5032);
    			attr_dev(button, "class", "chat-submit svelte-12yv98n");
    			button.disabled = /*botTyping*/ ctx[12];
    			add_location(button, file$1, 147, 8, 4898);
    			attr_dev(div7, "class", "chat-footer svelte-12yv98n");
    			add_location(div7, file$1, 141, 4, 4734);
    			attr_dev(div8, "id", /*uid*/ ctx[15]);
    			attr_dev(div8, "class", "chat svelte-12yv98n");
